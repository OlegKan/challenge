...
public class UpdateProfileCompletable implements CompletableOnSubscribe {
    ...
    public static Completable create(FirebaseDatabase firebaseDatabase, ProfileEntity profile) {
        return Completable.create(new UpdateProfileCompletable(firebaseDatabase, profile));
    }

    private UpdateProfileCompletable(FirebaseDatabase firebaseDatabase, ProfileEntity profile) {
