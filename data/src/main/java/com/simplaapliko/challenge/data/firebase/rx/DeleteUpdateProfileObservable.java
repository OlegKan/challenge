...
public class DeleteUpdateProfileObservable implements
        ObservableOnSubscribe<Pair<Profile, Integer>> {
    ...
    public static Observable<Pair<Profile, Integer>> create(FirebaseDatabase firebaseDatabase,
            Filter filter) {
        return Observable.create(new DeleteUpdateProfileObservable(firebaseDatabase, filter));
    }

    private DeleteUpdateProfileObservable(FirebaseDatabase firebaseDatabase, Filter filter) {
    ...
    private class ValueEventCallback implements ChildEventListener {
        ...
        public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
            ...
            if (profile != null) {
                emitter.onNext(new Pair<>(profile.toProfile(), 2));
            }
        }
        ...
        public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
            ...
            if (profile != null) {
                emitter.onNext(new Pair<>(profile.toProfile(), 1));
            }
        }
